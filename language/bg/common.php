...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> 'Превод: phpBB Bulgaria & Yoan Arnaudov',
	'DIRECTION'			=> 'ltr',
	'DATE_FORMAT'		=> '|d M Y|',	// January 1st, 2007 (with Relative days enabled)
	'DATETIME_FORMAT'	=> '|d M Y, H:i|',	// January 1st, 2007, 1:37 pm (with Relative days enabled)
	'USER_LANG'			=> 'bg-bg',
	...
	'ACP_SHORT'						=> 'АДМИН',
	'ACTIVATION_ALREADY_SENT'		=> 'Имейл за активация вече е изпратен на вашия имейл адрес. Можете да опитате отново след 24 часа. Ако продължавате да имате проблеми с активацията на акаунта, моля, свържете се с администратор на форума.',
	'ACTIVE'						=> 'Активно',
	...
	'ALL_TIMES'						=> 'Всички времена са <span title="%2$s">%1$s</span>',
	...
	'AUTH_PROVIDER_OAUTH_RETURN_ERROR'						=> 'Грешка! Вашата заявка не може да бъде обработена.',
	...
	'AVATAR_DISALLOWED_EXTENSION'	=> 'Този файл не може да бъде показан, защото разширението <strong>%s</strong> не е разрешено.',
	...
	'AVATAR_NO_UPLOAD_DIR'			=> 'Пътят за съхранение на аватари не съществува или не може да бъде записван.',
	'AVATAR_NO_UPLOAD_PATH'			=> 'Качването на аватари е разрешено, но пътят за съхранение на аватари не е зададен.',
	...
	'AVATAR_WRONG_FILESIZE'			=> 'Размерът на аватара трябва да бъде между 0 и %1$d %2$s.',
	...
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> 'Въведеният домейн на имейл адреса няма валиден MX запис.',
	'DOWNLOADED'			=> 'Свалено',
	...
	'FROM'					=> 'от',
	'FSOCK_DISABLED'		=> 'Операцията не може да бъде завършена, защото функцията <var>fsockopen</var> е изключена или заявеният сървър не може да бъде намерен.',
	...
	'HOURS'							=> 'Часа',
	'HOME'							=> 'Начало',
	'HTTP_HANDLER_NOT_FOUND'		=> 'Операцията не можа да бъде завършена, тъй като разширението cURL за PHP и настройката allow_url_fopen в PHP са деактивирани, а не беше намерен друг HTTP обработчик.',
	...
	'NOTIFICATION_GROUP_REQUEST'		=> '<strong>Заявка за група</strong> от %1$s за присъединяване към групата %2$s.',
	...
	'NOTIFICATION_REPORT_PM_CLOSED'		=> '<strong>Докладът е затворен</strong> от %1$s:',
	...
	'NO_CONNECT_TO_SMTP_HOST'	=> 'Не може да се осъществи връзка със SMTP хоста: %1$s : %2$s',
	...
	'POST_DISPLAY'			=> 'Покажи това мнение',
	...
	'ROUTE_NOT_FOUND'				=> 'Заявеният маршрут „%s“ не беше открит.',
	'ROUTE_INVALID_MISSING_PARAMS'	=> 'Невалидни или липсващи параметри за маршрут „%s“.',
	...
	'WARN_USER'			=> 'Предупреди потребителя',
