...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'С достъпа до „%1$s“ (наричан по-долу „ние“, „нас“, „наш“, „%1$s“, „%2$s“) Вие се съгласявате да бъдете правно обвързани със следните условия. Ако не сте съгласни да бъдете правно обвързани с всички изброени по-долу условия, моля, не осъществявайте достъп до и не използвайте „%1$s“. Можем да променяме тези условия по всяко време и ще положим всички усилия да Ви уведомим за такива промени. Въпреки това Ваша отговорност е редовно да преглеждате този документ, тъй като продължаването на използването на „%1$s“ след направени промени означава, че приемате да бъдете правно обвързани с актуализираните и/или изменени условия.
	<br><br>
	Нашите форуми използват phpBB (наричан по-долу „те“, „тях“, „техен“, „софтуерът phpBB“, „www.phpbb.com“, „phpBB Limited“, „phpBB Teams“) - система за дискусионни форуми, публикувана под лиценза „<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>“ (наричан по-долу „GPL“), която може да бъде изтеглена от <a href="https://www.phpbb.com/">www.phpbb.com</a>. Софтуерът phpBB единствено улеснява интернет-базирани дискусии; phpBB Limited не носи отговорност за съдържанието или поведението, разрешено или забранено на този сайт. За повече информация относно phpBB вижте: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	Съгласявате се да не публикувате материали с обиден, неприличен, вулгарен, клеветнически, изпълнен с омраза, заплашителен, сексуално ориентиран или по друг начин незаконен характер, независимо дали според законите на Вашата държава, държавата, в която се хоства „%1$s“, или международното право. Това може да доведе до незабавна и постоянна забрана за достъп, като при необходимост можем да уведомим Вашия доставчик на интернет услуги. IP адресът на всяка публикация се записва, за да подпомага прилагането на тези условия.
	<br><br>
	Съгласявате се, че „%1$s“ си запазва правото да премахва, редактира, премества или затваря всяка тема по всяко време и по наша собствена преценка. Като потребител се съгласявате, че всяка въведена от Вас информация може да бъде съхранявана в база данни. Въпреки че тази информация няма да бъде разкривана на трети страни без Вашето съгласие, нито „%1$s“, нито phpBB могат да бъдат държани отговорни за опит за неправомерен достъп, който може да доведе до компрометиране на данни.
	',
	'PRIVACY_POLICY'		=> 'Настоящата политика обяснява подробно как „%1$s“ и свързаните с него дружества (наричани по-долу „ние“, „нас“, „наш“, „%1$s“, „%2$s“) и phpBB (наричани по-долу „те“, „тях“, „техен“, „софтуерът phpBB“, „www.phpbb.com“, „phpBB Limited“, „phpBB Teams“) използват информацията, събрана по време на използването на този сайт (наричана по-долу „Вашата информация“).

		<br><br>

		Вашата информация се събира по два начина. При разглеждане на „%1$s“ софтуерът phpBB създава няколко „бисквитки“ (cookies). Бисквитките представляват малки текстови файлове, които се съхраняват временно от Вашия уеб браузър. Първите две бисквитки съдържат потребителски идентификатор (наричан по-долу „потребителски идентификатор“) и идентификатор на анонимната сесия (наричан по-долу „идентификатор на сесията“), които се генерират автоматично от софтуера phpBB. Трета бисквитка се създава, след като разгледате теми в „%1$s“, и съхранява информация кои теми сте прочели, като по този начин подобрява удобството при използване на форума.

		<br><br>

		По време на използването на „%1$s“ е възможно да бъдат създадени и допълнителни бисквитки, които не са част от софтуера phpBB. Те не попадат в обхвата на настоящата политика, която се отнася единствено за бисквитките, създадени от софтуера phpBB.

		<br><br>

		Вторият начин, по който събираме информация, е чрез данните, които Вие доброволно ни предоставяте. Това включва, но не се ограничава до: публикуване като гост (наричано по-долу „анонимни публикации“), регистрация в „%1$s“ (наричана по-долу „Вашият акаунт“) и публикации, които създавате след регистрация и след като сте влезли в профила си (наричани по-долу „Вашите публикации“).

		<br><br>

		Вашият акаунт съдържа най-малко следната информация: уникално потребителско име (наричано по-долу „Вашето потребителско име“), парола, използвана за вход (наричана по-долу „Вашата парола“), и валиден имейл адрес (наричан по-долу „Вашият имейл адрес“). Данните за Вашия акаунт в „%1$s“ се защитават съгласно приложимото законодателство за защита на личните данни в държавата, в която се хоства форумът. Всяка допълнителна информация, различна от потребителското име, паролата и имейл адреса, която се изисква по време на регистрацията, може да бъде задължителна или незадължителна по преценка на „%1$s“. Във всички случаи Вие можете да изберете коя информация от профила Ви да бъде публично видима. Освен това имате възможност да се абонирате или да се откажете от автоматично генерираните имейли, изпращани от софтуера phpBB.

		<br><br>

		Вашата парола се съхранява като еднопосочен криптографски хеш с цел осигуряване на сигурност. Въпреки това препоръчваме да не използвате една и съща парола за различни сайтове. Паролата Ви е средството за достъп до акаунта Ви в „%1$s“, затова я пазете внимателно. При никакви обстоятелства представители на „%1$s“, phpBB или трети страни няма да поискат от Вас да им предоставите паролата си. Ако забравите паролата си, можете да използвате функцията „Забравена парола“, предоставена от софтуера phpBB. При тази процедура ще бъдете помолени да въведете потребителското си име и имейл адреса си, след което софтуерът phpBB ще Ви позволи да зададете нова парола, за да възстановите достъпа до акаунта си.
    ',
));
...
$lang = array_merge($lang, array(
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> 'Синтаксисът използва същия формат като PHP <a href="https://www.php.net/manual/datetime.format.php">функциите за дата</a>.',
	'BOARD_LANGUAGE'			=> 'Език',
	'BOARD_STYLE'				=> 'Стил',
	...
	'DEFAULT_ACTION_EXPLAIN'	=> 'Това действие ще се изпълни, ако нито едно от горните не е приложимо.',
	...
	'FIELD_TOO_SMALL'					=> 'Стойността на „%2$s“ е твърде малка; изискваната минимална стойност е %1$d.',
	'FIELD_TOO_LARGE'					=> 'Стойността на „%2$s“ е твърде голяма; максимално допустимата стойност е %1$d.',
	...
	'NOTIFICATION_TYPE_FORUM'							=> 'Някой отговари в тема във форум, за който сте абонирани',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Вашият доклад за публикация е затворен от модератор',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'Някой е докладвал лично съобщение',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'Вашият доклад за лично съобщение е затворен от модератор',
	...
	'PERMISSIONS_TRANSFERRED'	=> 'Правата от <strong>%s</strong> бяха прехвърлени успешно; вече можете да разглеждате форума с правата на този потребител.<br />Имайте предвид, че администраторските права не бяха прехвърлени. Можете да се върнете към собствения си набор от права по всяко време.',
	...
	'YOUR_FOES'					=> 'Врагове',
	'YOUR_FOES_EXPLAIN'			=> 'За да премахнете потребителски имена, изберете ги и натиснете изпращане.',
	'YOUR_FRIENDS'				=> 'Приятели',
	'YOUR_FRIENDS_EXPLAIN'		=> 'За да премахнете потребителски имена, изберете ги и натиснете изпращане.',
