...
$lang = array_merge($lang, array(
	...
	'BBCODE_O_HELP'				=> 'Подреден списък: напр. [list=1][*]Първа точка[/list] или [list=a][*]Точка a[/list]',
	'BBCODE_P_HELP'				=> 'Добави изображение: [img]http://image_url[/img]  (alt+p)',
	'BBCODE_Q_HELP'				=> 'Цитиран текст: [quote]текст[/quote]  (alt+q)',
	'BBCODE_S_HELP'				=> 'Цвят на шрифта: [color=red]текст[/color] или [color=#FF0000]текст[/color]',
	...
	'MAX_ATTACHMENT_FILESIZE'	=> 'Максимален размер на файл за прикачен файл: %s.',
	'MAX_FONT_SIZE_EXCEEDED'	=> 'Можете да използвате шрифт с размер най-много %d.',
	...
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> 'Изображенията могат да бъдат широки най-много %d пиксел.',
		2	=> 'Изображенията могат да бъдат широки най-много %d пиксела.',
	),
	...
	'PHP_SIZE_NA'				=> 'Размерът на прикачения файл е твърде голям.<br />Не може да се определи максималният размер, зададен от PHP в php.ini.',
