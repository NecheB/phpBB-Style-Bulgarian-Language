...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_AUTO_LOGOUT_ANSWER'	=> 'Ако не отбележите полето <em>Запомни ме</em> при вход, форумът ще Ви държи вписани само за предварително зададено време. Това предотвратява злоупотреба с профила Ви от други лица. За да останете вписани, отбележете полето <em>Запомни ме</em> при вход. Това не се препоръчва, ако използвате форума от споделен компютър, например библиотека, интернет кафе, университетска компютърна зала и др. Ако не виждате това поле, администратор на форума е изключил тази функция.',
	...
	'HELP_FAQ_LOGIN_LOST_PASSWORD_ANSWER'	=> 'Не се притеснявайте! Въпреки че паролата Ви не може да бъде извлечена, тя може лесно да бъде нулирана. Отворете страницата за вход и натиснете <em>Забравих паролата си</em>. Следвайте инструкциите и скоро трябва отново да можете да влезете.<br />Ако не успеете да нулирате паролата си, свържете се с администратор на форума.',
	...
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_ANSWER'	=> 'Във Вашия потребителски контролен панел, под „Настройки на форума“, ще намерите опцията <em>Скрий онлайн статуса ми</em>. Включете тази опция и ще бъдете видими само за администраторите, модераторите и за себе си. Ще бъдете отчетени като скрит потребител.',
