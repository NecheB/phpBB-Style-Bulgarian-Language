...
$lang = array_merge($lang, array(
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'Нещо се обърка по време на заявката и беше хвърлено изключение. Промените, направени преди възникването на грешката, бяха отменени в най-добрите ни възможности, но трябва да проверите форума за грешки.',
	...
	'ROLE_ASSIGNED_NOT_EXIST'			=> 'Потребителската роля, назначена на групата "%1$s", не съществува. Идентификатор на ролята: "%2$s"',
