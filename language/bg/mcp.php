...
$lang = array_merge($lang, array(
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Използвайте този формуляр, за да докладвате избраното лично съобщение. Докладването обикновено трябва да се използва само ако съобщението нарушава правилата на форума. <strong>Докладването на лично съобщение ще направи съдържанието му видимо за всички модератори.</strong>',
	'REPORT_NOTIFY'				=> 'Уведоми ме',
	'REPORT_NOTIFY_EXPLAIN'		=> 'Уведомява Ви, когато сигналът Ви бъде обработен.',
