...
$lang = array_merge($lang, array(
	'CLI_APCU_CACHE_NOTICE'				=> 'APCu кешът трябва да бъде изчистен през Административния панел.',
	...
	'CLI_DESCRIPTION_REPARSER_REPARSE_OPT_FORCE_BBCODE'	=> 'Преработване на всички BBCode без изключения. Имайте предвид, че всички BBCode, които са били деактивирани, ще бъдат преработени, активирани и напълно визуализирани.',
	...
	'CLI_DESCRIPTION_USER_DELETE_ID'			=> 'Изтриване на потребителски акаунти по ID.',
	'CLI_DESCRIPTION_USER_DELETE_ID_OPTION_ID'	=> 'IDs на потребителите, които да бъдат изтрити',
	...
	'CLI_USER_DELETE_ID_CONFIRM'	=> 'Сигурни ли сте, че искате да изтриете потребителските ID-та „%s”? [y/N]',
	'CLI_USER_DELETE_ID_SUCCESS'	=> 'Потребителските ID-та бяха успешно изтрити.',
	'CLI_USER_DELETE_ID_START'		=> 'Изтриване на потребители по ID',
	'CLI_USER_DELETE_NONE'			=> 'Не бяха изтрити потребители по ID.',
