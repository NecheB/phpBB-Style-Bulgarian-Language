...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'В phpBB3 всичко е базирано на форуми. Категорията е само специален тип форум. Всеки форум може да има неограничен брой подфоруми и можете да определите дали във всеки от тях може да се публикува или не (т.е. дали да действа като стара категория). Тук можете да добавяте, редактирате, изтривате, заключвате и отключвате отделни форуми, както и да задавате допълнителни контроли. Ако публикациите и темите са се разсинхронизирали, можете също да синхронизирате форум отново. <strong>Трябва да копирате или зададете подходящи права за новосъздадените форуми, за да бъдат показани.</strong>',
	...
	'FORUM_LINK_EXPLAIN'				=> 'Пълен URL адрес (включително протокола, напр.: <samp>http://</samp>) към местоназначението, към което ще бъде отведен потребителят при натискане на този форум, напр.: <samp>http://www.phpbb.com/</samp>.',
