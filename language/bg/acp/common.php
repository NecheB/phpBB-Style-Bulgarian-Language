...
$lang = array_merge($lang, array(
	...
	'CSV_INVALID'			=> 'Предоставената настройка “%1$s” е невалидна. Стойностите трябва да са разделени само с запетая и не трябва да съдържат водещи или заключителни разделители.',
	...
	'URL_SCHEME_INVALID'	=> 'Предоставената схема “%2$s” в настройката с разделители запетая “%1$s” е невалидна. Схемата трябва да започва с латински символ, последван от букви, цифри, тирета или точки.',
...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> 'Тази страница показва информация за версията на PHP, инсталирана на този сървър. Тя включва подробности за заредените модули, наличните променливи и настройките по подразбиране. Тази информация може да бъде полезна при диагностициране на проблеми. Имайте предвид, че някои хостинг компании ограничават показваната тук информация от съображения за сигурност. Препоръчва се да не предоставяте никакви данни от тази страница, освен ако не бъдете помолени от <a href="https://www.phpbb.com/about/team/">официални членове на екипа</a> във форумите за поддръжка.',
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> трябва да бъде оставено празно. Можете да проверите текущата стойност на страницата <samp>PHP информация</samp>.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP output character conversion е неправилно настроена.',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> трябва да бъде оставено празно. Можете да проверите текущата стойност на страницата <samp>PHP информация</samp>.',
	'ERROR_DEFAULT_CHARSET'							=> 'Кодировката по подразбиране е неправилно конфигурирана',
	'ERROR_DEFAULT_CHARSET_EXPLAIN'					=> '<var>default_charset</var> трябва да бъде зададено на <samp>UTF-8</samp>. Можете да проверите текущата стойност на страницата <samp>PHP информация</samp>.',
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> 'Моля, изпратете информация за конфигурацията на Вашия сървър и форум към phpBB за статистически анализ. Цялата информация, която може да идентифицира Вас или уебсайта Ви, е премахната - данните са напълно <strong>анонимни</strong>. Въз основа на тази информация вземаме решения за бъдещи версии на phpBB. Статистиката се публикува публично. Споделяме тези данни и с проекта PHP, езика за програмиране, на който е създаден phpBB.',
...
$lang = array_merge($lang, array(
	...
	'LOG_SPAMHAUS_OPEN_RESOLVER'		=> 'Spamhaus не позволява заявки, използващи отворен резолвер. Проверката за черни списъци е деактивирана. За повече информация, вижте https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	'LOG_SPAMHAUS_VOLUME_LIMIT'			=> 'Превишен е лимитът за заявки към Spamhaus. Проверката за черни списъци е деактивирана. За повече информация, вижте https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
