...
$lang = array_merge($lang, array(
	...
	'ACL_NEVER'				=> 'Никога',
	'ACL_SET'				=> 'Права',
	'ACL_SET_EXPLAIN'		=> 'Правата са базирани на проста система <strong>ДА</strong>/<strong>НЕ</strong>. Задаването на опция на <strong>НИКОГА</strong> за потребител или група отменя всяка друга стойност, зададена за нея. Ако не желаете да задавате стойност за опция за този потребител или група, изберете <strong>НЕ</strong>. Ако стойности за тази опция са зададени другаде, те ще бъдат използвани с предимство; в противен случай се приема <strong>НИКОГА</strong>. Всички маркирани обекти (с отметката пред тях) ще копират набора от права, който сте дефинирали. Имайте предвид, че задаването на административни права за профили на основатели няма ефект, защото администраторските права за основатели винаги са зададени на <strong>ДА</strong>.',
	...
	'ALL_NEVER'					=> 'Всички <strong>Никога</strong>',
	'ALL_NO'					=> 'Всички <strong>Не</strong>',
	'ALL_USERS'					=> 'Избери всички потребители',
	'ALL_YES'					=> 'Всички <strong>Да</strong>',
	'APPLY_ALL_PERMISSIONS'		=> 'Приложи всички права',
	'APPLY_PERMISSIONS'			=> 'Приложи правата',
	'APPLY_PERMISSIONS_EXPLAIN'	=> 'Правата и ролята, зададени за този елемент, ще бъдат приложени само към този елемент и към всички маркирани елементи.',
	...
	'DELETE_ROLE_CONFIRM'		=> 'Сигурни ли сте, че искате да премахнете тази роля? Обектите, на които е зададена тази роля, <strong>няма</strong> да загубят настройките си за права.',
	...
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> 'Задаването на тази роля не променя правата вдясно. Ако искате да изчистите/премахнете всички права, трябва да използвате връзката „Всички <strong>НЕ</strong>“.',
	...
	'ROLE_DESCRIPTION_FORUM_NEW_MEMBER'		=> 'Роля за членове на специалната група за новорегистрирани потребители; съдържа права <strong>НИКОГА</strong>, които ограничават функции за нови потребители.',
	...
	'ROLE_DESCRIPTION_USER_NEW_MEMBER'		=> 'Роля за членове на специалната група за новорегистрирани потребители; съдържа права <strong>НИКОГА</strong>, които ограничават функции за нови потребители.',
	...
	'TRACE_DEFAULT'					=> 'По подразбиране всичко е зададено като <strong>Не</strong> за да може да бъде променяно.',
	'TRACE_FOR'						=> 'Чертай за',
	'TRACE_GLOBAL_SETTING'			=> '%s (глобално)',
	'TRACE_GROUP_NEVER_TOTAL_NEVER'	=> 'Правата на тази група са зададени на <strong>Никога</strong>.',
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'Правата на тази група са зададени на <strong>Никога</strong>, стария резултат се запазва.',
	'TRACE_GROUP_NEVER_TOTAL_NO'	=> 'Правото на тази група е зададено на <strong>НИКОГА</strong>, което става новата обща стойност, защото още не е било зададено (било е <strong>НЕ</strong>).',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Правото на тази група за този форум е зададено на <strong>НИКОГА</strong>, което става новата обща стойност, защото още не е било зададено (било е <strong>НЕ</strong>).',
	'TRACE_GROUP_NEVER_TOTAL_YES'	=> 'Правата на тази група са зададени на <strong>Никога</strong> което заменя <strong>Да</strong> на <strong>Никога</strong> за този потребител.',
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'Правата на тази група са зададени на <strong>Никога</strong> което замества <strong>Да</strong> на <strong>Никога</strong> за този потребител.',
	'TRACE_GROUP_NO'				=> 'Правото е <strong>Не</strong> за тази група, старата стойност е запазена.',
	'TRACE_GROUP_NO_LOCAL'			=> 'Правилото е <strong>Не</strong> за тази група, старата стойност се запазва.',
	'TRACE_GROUP_YES_TOTAL_NEVER'	=> 'Правата на тази група са зададени на <strong>Да</strong>, но <strong>Никога</strong> не може да бъде заместено.',
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'	=> 'Правата на тази група са зададени на <strong>Да</strong>, но <strong>Никога</strong> не може да бъде заместено.',
	'TRACE_GROUP_YES_TOTAL_NO'		=> 'Правото на тази група е зададено на <strong>ДА</strong>, което става новата обща стойност, защото още не е било зададено (било е <strong>НЕ</strong>).',
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Правото на тази група за този форум е зададено на <strong>ДА</strong>, което става новата обща стойност, защото още не е било зададено (било е <strong>НЕ</strong>).',
	'TRACE_GROUP_YES_TOTAL_YES'		=> 'Правото на тази група е зададено на <strong>ДА</strong> и общото право вече е зададено на <strong>ДА</strong>, затова общият резултат се запазва.',
	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'	=> 'Правото на тази група за този форум е зададено на <strong>ДА</strong> и общото право вече е зададено на <strong>ДА</strong>, затова общият резултат се запазва.',
	'TRACE_PERMISSION'				=> 'Проследяване на права - %s',
	'TRACE_RESULT'					=> 'Резултат от проследяване',
	'TRACE_SETTING'					=> 'Настройки на проследяване',

	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> 'Независимото от форум потребителско право се оценява като <strong>ДА</strong>, но общото право вече е зададено на <strong>ДА</strong>, затова общият резултат се запазва. %sПроследи глобалното право%s',
	'TRACE_USER_GLOBAL_YES_TOTAL_NEVER'		=> 'Форум независимите права са зададени на <strong>Да</strong>, което замества старите <strong>Никога</strong>. %sПроследи глобалните права%s',
	'TRACE_USER_GLOBAL_NEVER_TOTAL_KEPT'	=> 'Форум независимите права са зададени на <strong>Никога</strong> което не влияе на локалните права. %sПроследи глобалните права%s',

	'TRACE_USER_FOUNDER'					=> 'Потребителят е основател, администраторските права винаги са <strong>ВКЛЮЧЕНИ</strong>.',
	'TRACE_USER_KEPT'						=> 'Потребителските права са задедени на <strong>Не</strong> старите права се запазват.',
	'TRACE_USER_KEPT_LOCAL'					=> 'Потребителските права са задедени на <strong>Не</strong> старите права също, няма промени.',
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> 'Потребителските права са задедени на <strong>НИКОГА</strong> е главната стойност е <strong>НИКОГА</strong>, so nothing is changed.',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'Правото на потребителя за този форум е зададено на <strong>НИКОГА</strong> и общата стойност е <strong>НИКОГА</strong>, затова нищо не се променя.',
	'TRACE_USER_NEVER_TOTAL_NO'				=> 'Потребителските права са задедени на <strong>НИКОГА</strong> което става главна стойност.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'Потребителските права са зададени на <strong>Никога</strong> което става новата стойност, защото старата беше Не.',
	'TRACE_USER_NEVER_TOTAL_YES'			=> 'Потребителските права са задедени на <strong>Никога</strong> е замества старата <strong>Да</strong>.',
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> 'Правото на потребителя за този форум е зададено на <strong>НИКОГА</strong> и заменя предишното <strong>ДА</strong>.',
	'TRACE_USER_NO_TOTAL_NO'				=> 'Потребителските права са задедени на <strong>Не</strong> и главната стойност е Не, затова става по подразбиране на <strong>Никога</strong>.',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'Потребителските права са задедени на <strong>Не</strong>, връща се стойността по подразбиране <strong>Никога</strong>.',
	'TRACE_USER_YES_TOTAL_NEVER'			=> 'Потребителските права са задедени на <strong>Да</strong> но главната стойност <strong>НИКОГА</strong> не може да бъде заместена.',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'Потребителските права са задедени на <strong>Да</strong>, но стойността <strong>Никога</strong> не може да бъде заместена.',
	'TRACE_USER_YES_TOTAL_NO'				=> 'Потребителските права са задедени на <strong>Да</strong> което става главна стойност, защото преди беше на <strong>Не</strong>.',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> 'Правото на потребителя за този форум е зададено на <strong>ДА</strong>, което става общата стойност, защото е било зададено на <strong>НЕ</strong>.',
	'TRACE_USER_YES_TOTAL_YES'				=> 'Потребителските права са задедени на <strong>Да</strong> и главната стойност е <strong>Да</strong> - нищо не е променено.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'Правото на потребителя за този форум е зададено на <strong>ДА</strong> и общата стойност е <strong>ДА</strong>, затова нищо не се променя.',
	'TRACE_WHO'								=> 'Кой',
	'TRACE_TOTAL'							=> 'Общо',
