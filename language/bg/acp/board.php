...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Синтаксисът използва същия формат като PHP <a href="https://www.php.net/manual/datetime.format.php">функциите за дата</a>.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOOKMARKS_EXPLAIN'	=> 'Потребителят може да съхранява лични отметки.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'			=> 'Аватари, свързани от друг уебсайт.<br><em><strong class="error">Предупреждение:</strong> Включването на тази функция може да позволи на потребителите да проверяват за съществуването на файлове и услуги, достъпни само в локалната мрежа.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Позволи отдалечено качване на аватари',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Разрешава качване на аватари от друг уебсайт.<br><em><strong class="error">Предупреждение:</strong> Включването на тази функция може да позволи на потребителите да проверяват за съществуването на файлове и услуги, достъпни само в локалната мрежа.</em>',
	'ALLOW_UPLOAD'					=> 'Позволи качването на аватари',
	'AVATAR_GALLERY_PATH'			=> 'Път към галерията на аватари',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Път под основната директория на phpBB за предварително заредени изображения, напр. <samp>images/avatars/gallery</samp>.<br>Двойни точки като <samp>../</samp> ще бъдат премахнати от пътя от съображения за сигурност.',
	'AVATAR_STORAGE_PATH'			=> 'Път към папката за качване на аватари',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Път под основната директория на phpBB, напр. <samp>images/avatars/upload</samp>.<br>Качването на аватари <strong>няма да бъде достъпно</strong>, ако в този път не може да се записва.<br>Двойни точки като <samp>../</samp> ще бъдат премахнати от пътя от съображения за сигурност.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_POST_FLASH_EXPLAIN'			=> 'Ако не е разрешено, BBCode тагът <code>[FLASH]</code> е забранен в публикациите. В противен случай системата за права определя кои потребители могат да използват BBCode тага <code>[FLASH]</code>.',
	...
	'DISPLAY_LAST_EDITED_EXPLAIN'	=> 'Изберете дали информацията „последно редактирано от“ да се показва в публикациите.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> 'Определя дали потребителите получават незабавен достъп до форума, или се изисква потвърждение. Можете също напълно да забраните новите регистрации. <em>„Имейл за целия форум“ трябва да бъде включен, за да се използва активация от потребител или администратор.</em>',
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Ако е зададено на „Да“ и е посочено ограничение за публикациите на нов член, новорегистрираните потребители не само ще бъдат поставени в групата <em>Новорегистрирани потребители</em>, но тази група ще бъде и тяхната група по подразбиране. Това може да е полезно, ако искате да зададете ранг и/или аватар по подразбиране за групата, които потребителят наследява.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Включва HTTP удостоверяване, което позволява на потребителите да имат достъп до съдържание, скрито за гости, като добавят параметъра <samp>auth=http</samp> към URL адреса на емисията. Имайте предвид, че някои PHP конфигурации може да изискват допълнителни промени във файла .htaccess; вижте указанията в този файл. HTTP удостоверяването се поддържа само през криптирани (https) връзки.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Тези данни определят информацията, използвана за изпращане на бисквитки към браузърите на потребителите. В повечето случаи стойностите по подразбиране за настройките на бисквитките са достатъчни. Ако се наложи да ги промените, правете го внимателно, защото неправилните настройки могат да попречат на потребителите да влизат. Ако имате проблеми с оставането на потребителите вписани във форума, посетете <strong><a href="https://www.phpbb.com/support/go/cookie-settings">базата знания на phpBB.com - коригиране на неправилни настройки на бисквитките</a></strong>.',

	'COOKIE_DOMAIN'				=> 'Бисквитка домейн',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'В повечето случаи домейнът на бисквитките е незадължителен. Оставете го празен, ако не сте сигурни.<br><br> Ако форумът е интегриран с друг софтуер или използвате няколко домейна, за да определите домейна на бисквитките, направете следното. Ако имате нещо като <i>example.com</i> и <i>forums.example.com</i>, или например <i>forums.example.com</i> и <i>blog.example.com</i>, премахвайте поддомейните, докато намерите общия домейн, <i>example.com</i>. След това добавете точка пред общия домейн и въведете .example.com (обърнете внимание на точката в началото).',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Всеки OAuth доставчик изисква уникална тайна и ключ за удостоверяване към външния сървър. Те се предоставят от OAuth услугата при регистриране на Вашия уебсайт и трябва да бъдат въведени точно както са Ви дадени.<br>Услуга, за която тук не са въведени и ключ, и тайна, няма да бъде достъпна за потребителите на форума. Имайте предвид също, че потребителят все още може да се регистрира и вписва чрез приставката за DB удостоверяване.',
	...
	'LDAP_EMAIL_EXPLAIN'			=> 'Задайте това на името на имейл атрибута в потребителския запис (ако съществува), за да се задава автоматично имейл адресът за нови потребители. Ако го оставите празно, потребителите, които влизат за първи път, ще имат празен имейл адрес.',
	...
	'LDAP_PASSWORD_EXPLAIN'			=> 'Оставете празно за анонимно свързване; в противен случай въведете паролата за горния потребител. Изисква се за Active Directory сървъри.<br><em><strong>Предупреждение:</strong> Тази парола ще бъде съхранена като обикновен текст в базата данни и ще бъде видима за всеки, който има достъп до базата данни или може да преглежда тази страница с настройки.</em>',
	'LDAP_PORT'						=> 'LDAP порт',
	...
	'LDAP_USER'						=> 'LDAP потребител <var>dn</var>',
	'LDAP_USER_EXPLAIN'				=> 'Оставете празно за анонимно свързване. Ако е попълнено, phpBB използва посоченото отличително име при опити за вход, за да намери правилния потребител, напр. <samp>uid=Username,ou=MyUnit,o=MyCompany,c=US</samp>. Изисква се за Active Directory сървъри.',
...
$lang = array_merge($lang, array(
	...
	'SERVER_PROTOCOL_EXPLAIN'	=> 'Това се използва като протокол на сървъра, ако тези настройки са принудително наложени. Ако е празно или не е наложено, протоколът се определя от настройките за защитена бисквитка (<samp>http://</samp> или <samp>https://</samp>).',
...
$lang = array_merge($lang, array(
	...
	'FORWARDED_FOR_VALID_EXPLAIN'	=> 'Сесиите ще продължат само ако изпратеният хедър <var>X_FORWARDED_FOR</var> съвпада с този, изпратен при предишната заявка. Забраните също ще се проверяват спрямо IP адресите в <var>X_FORWARDED_FOR</var>.',
	'IP_VALID'						=> 'Валидиране на IP Сесията',
	'IP_VALID_EXPLAIN'				=> 'Определя каква част от IP адреса на потребителя се използва за валидиране на сесията; <samp>All</samp> сравнява целия адрес, <samp>A.B.C</samp> - първите x.x.x, <samp>A.B</samp> - първите x.x, а <samp>None</samp> изключва проверката. При IPv6 адреси <samp>A.B.C</samp> сравнява първите 4 блока, а <samp>A.B</samp> - първите 3 блока.',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_EMAIL_EXPLAIN'			=> 'Това ще се използва като адрес на подателя за всички имейли, т.е. техническият имейл адрес за контакт. В имейлите винаги ще се използва като адрес <samp>Return-Path</samp> и <samp>Sender</samp>.',
	...
	'CONTACT_EMAIL_EXPLAIN'			=> 'Този адрес ще се използва винаги когато е необходим конкретен контакт, напр. за спам, съобщения за грешки и др. В имейлите винаги ще се използва като адрес <samp>From</samp> и <samp>Reply-To</samp>.',
	...
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'Това ще зададе <samp>Return-Path</samp> към имейл адреса на подателя, вместо да използва локалния потребител и името на хоста на сървъра. Тази настройка не важи при използване на SMTP.<br><em><strong>Предупреждение:</strong> Изисква потребителят, под който работи уебсървърът, да бъде добавен като доверен потребител в конфигурацията на sendmail.</em>',
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Въведете парола само ако SMTP сървърът Ви я изисква.<br><em><strong>Предупреждение:</strong> Тази парола ще бъде съхранена като обикновен текст в базата данни и ще бъде видима за всеки, който има достъп до базата данни или може да преглежда тази страница с настройки.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
