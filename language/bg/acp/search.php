...
$lang = array_merge($lang, array(
	...
	'DEFAULT_SEARCH_RETURN_CHARS'			=> 'По подразбиране брой на върнатите символи',
	'DEFAULT_SEARCH_RETURN_CHARS_EXPLAIN'	=> 'По подразбиране броят символи, които ще се върнат при търсене. Стойност 0 ще върне целия пост.',
	...
	'SEARCH_INDEX_CREATE_REDIRECT'			=> array(
		2	=> 'Всички мнения до ID %2$d вече са индексирани, като %1$d мнения бяха обработени в тази стъпка.',
	),
	'SEARCH_INDEX_CREATE_REDIRECT_RATE'		=> array(
		2	=> 'Текущата скорост на индексиране е приблизително %1$.1f мнения в секунда.',
	),
	'SEARCH_INDEX_DELETE_REDIRECT'			=> array(
		2	=> 'Всички мнения до ID %2$d бяха премахнати от индекса за търсене, като %1$d мнения бяха обработени в тази стъпка.',
	),
	'SEARCH_INDEX_DELETE_REDIRECT_RATE'		=> array(
		2	=> 'Текущата скорост на изтриване е приблизително %1$.1f мнения в секунда.',
	),
	'SEARCH_INDEX_CREATED'					=> 'Успешно са изтрити всички мнения.',
	'SEARCH_INDEX_PROGRESS'					=> 'Завършени: %1$d | В очакване: %2$d | Общо: %3$d',
