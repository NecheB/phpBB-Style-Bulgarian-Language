...
$lang = array_merge($lang, array(
	...
	'DISPLAY_ORDER_EXPLAIN'			=> 'Показва прикачените файлове, подредени по време.',
	...
	'IMAGE_QUALITY'				=> 'Качество на качените изображения (само JPEG)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Посочете стойност между 50% (по-малък размер на файла) и 90% (по-високо качество). Качество над 90% увеличава размера на файла и е забранено. Настройката важи само ако максималните размери на изображението са различни от 0px на 0px.',
	'IMAGE_STRIP_METADATA'		=> 'Премахване на метаданни от изображението (само JPEG)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Премахване на Exif метаданни, като например името на автора, GPS координати и детайли за камерата. Настройката важи само ако максималните размери на изображението са различни от 0px на 0px.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Максимални размери на прикачените изображения. phpBB може автоматично да преоразмерява изображенията преди качване, така че да не надвишават зададените максимални размери. Задайте и двете стойности на 0 × 0 px, за да изключите проверката на размерите и автоматичното преоразмеряване.',
	...
	'NO_EXT_GROUP'				=> 'Няма',
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Няма <a href="%s">разрешени типове файлове за прикачване</a> към лични съобщения.',
	'NO_EXT_GROUP_ALLOWED_POST'	=> 'Няма <a href="%s">разрешени типове файлове за прикачване</a> към публикации.',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Променя поведението по подразбиране на списъка Разрешаване/Забрана при включени защитени изтегляния към <strong>бял списък</strong> (Разрешаване) или <strong>черен списък</strong> (Забрана).',
	...
	'UPLOAD_POST_NOT_EXIST'         => 'Файлът „%1$s“ не може да бъде качен към публикация %2$d, тъй като публикацията не съществува.',
));
