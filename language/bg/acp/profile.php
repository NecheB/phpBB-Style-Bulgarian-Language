...
$lang = array_merge($lang, array(
	...
	'BOOL_TYPE_EXPLAIN'		=> 'Определете типа - отметка или радио бутони. Отметката ще се показва само ако е избрана за даден потребител. В този случай ще се използва <strong>втората</strong> езикова опция. Радио бутоните се показват независимо от стойността си.',
