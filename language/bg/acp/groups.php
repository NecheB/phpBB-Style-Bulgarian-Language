...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Тази настройка заменя ограничението за броя съобщения в папка за отделен потребител. Максимумът за всички групи на потребителя се използва за определяне на реалната стойност.<br />Задайте тази стойност на 0, за да замените настройката за всички потребители от тази група с общата настройка на форума.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'Максималният брой разрешени получатели в лично съобщение. Максимумът за всички групи на потребителя се използва за определяне на реалната стойност.<br />Задайте тази стойност на 0, за да замените настройката за всички потребители от тази група с общата настройка на форума.',
	...
	'USER_GROUP_DEFAULT_EXPLAIN'	=> 'Изборът на „Да“ тук ще зададе тази група като група по подразбиране за добавените потребители.',
