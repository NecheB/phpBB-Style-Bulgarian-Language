...
$lang = array_merge($lang, array(
	...
	'TOKEN'					=> 'Знак',
	'TOKENS'				=> 'Знаци',
	'TOKENS_EXPLAIN'		=> 'Маркерите са заместители за въведено от потребителя съдържание. Въведеното съдържание ще бъде валидирано само ако отговаря на съответната дефиниция. При нужда можете да ги номерирате, като добавите число като последен знак в скобите, напр. {TEXT1}, {TEXT2}.<br /><br />В HTML заместването можете също да използвате всеки езиков низ, наличен във Вашата директория language/, по следния начин: {L_<em>&lt;STRINGNAME&gt;</em>}, където <em>&lt;STRINGNAME&gt;</em> е името на преведения низ, който искате да добавите. Например {L_WROTE} ще бъде показано като „wrote“ или като превода му според локала на потребителя.<br /><br /><strong>Имайте предвид, че в персонализирани BBCode могат да се използват само маркерите, изброени по-долу.</strong>',
	...
	'tokens'	=>	array(
		...
		'COLOR'			=> '<samp>rgb(0,0,255)</samp>, <samp>#0000ff</samp>, <samp>blue</samp> или <a href="http://www.w3.org/TR/CSS21/syndata.html#value-def-color">CSS цветова стойност</a>',
		'ALNUM'			=> 'Букви от латинската азбука (A-Z) и цифри.',
		'CHOICE'		=> 'Избор от зададени стойности, напр. <samp>{CHOICE=спатии,сърца,диаманти,клубове}</samp>. Стойностите се третират като нечувствителни към главни/малки букви по подразбиране и могат да се третират като чувствителни към тях чрез опцията <samp>caseSensitive</samp>: <samp>{CHOICE=Спатии,Сърца,Диаманти,Клубове;caseSensitive}</samp>',
		'FLOAT'			=> 'Десетично число, напр. <samp>0.5</samp>.',
		'HASHMAP'		=> 'Свързва низове с техните замествания във формат <samp>{HASHMAP=низ1:заместване1,низ2:заместване2}</samp>. Чувствително към главни/малки букви. Запазва непознати стойности по подразбиране.',
		'INT'			=> 'Цяло число, напр. <samp>2</samp>.',
		'IP'			=> 'Валиден IPv4 или IPv6 адрес.',
		'IPPORT'		=> 'Валиден IPv4 или IPv6 адрес с порт номер.',
		'IPV4'			=> 'Валиден IPv4 адрес.',
		'IPV6'			=> 'Валиден IPv6 адрес.',
		'MAP'			=> 'Свързва низове с техните замествания във формат <samp>{MAP=низ1:заместване1,низ2:заместване2}</samp>. Нечувствително към главни/малки букви. Запазва непознати стойности по подразбиране.',
		'RANGE'			=> 'Приема цяло число в даден диапазон, напр. <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'Проверява стойността си спрямо зададено регулярно изражение, напр. <samp>{REGEXP=/^foo\\w+bar$/}</samp>.',
		'TIMESTAMP'		=> 'Времеви маркер като <samp>1ч30м10с</samp>, който ще бъде преобразуван в брой секунди. Приема също и число.',
		'UINT'			=> 'Беззнаково цяло число. Същото като <samp>{INT}</samp>, но отхвърля стойности по-малки от 0.',
 	),
));
...
$lang = array_merge($lang, array(
	...
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'Причината <strong>не</strong> е локализирана. Ако искате да предоставите локализирана форма, посочете правилния ключ от секцията за причини за сигнали в езиковите файлове.',
	'IS_TRANSLATED'				=> 'Причината е локализирана.',
	'IS_TRANSLATED_EXPLAIN'		=> 'Причината е локализирана. Ако заглавието, което въведете тук, е посочено в секцията за причини за сигнали в езиковите файлове, ще се използва локализираната форма на заглавието и описанието.',
